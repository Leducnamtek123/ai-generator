...
import type { Member } from '@/services/workspaceApi';
import { useWorkspaceStore } from '@/stores/workspace-store';
import { WorkspaceMembersSkeleton } from '@/components/common/loading-skeletons';
import {
    Users,
    Shield,
    ShieldCheck,
    ...
    return (
        <div className="max-w-3xl mx-auto py-8 px-4 sm:px-6">
            ...
            <ConfirmDialog
                ...
                description={
                    memberToRemove
                        ? `Remove ${memberToRemove.user?.name || memberToRemove.user?.email || 'this member'} from the workspace?`
