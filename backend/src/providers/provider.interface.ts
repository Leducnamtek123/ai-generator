...
export interface AIProvider {
     ...
     */
    generateVideo(prompt: string, options?: VideoOptions): Promise<GenerationResult>;

    /**
     * Upscale an existing image
     */
    upscaleImage(imageUrl: string, options?: UpscaleOptions): Promise<GenerationResult>;
 ...
 */
export type ProviderType = 'n8n' | 'leonardo' | 'openai' | 'runway' | 'replicate';
